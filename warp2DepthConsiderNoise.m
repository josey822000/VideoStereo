function [outD1 outD2 Check1 Check2 outBound1 outBound2] = warp2DepthConsiderNoise( Depth1, Depth2, Obj1, Obj2,otherView1,otherView2,X1,X2)
...
%     imshow(CheckObj1);
    ...
    mpSeg2_2 = reshape(otherView2.segMap(warpY2+size(Depth2,1)*(warpX2_1-1)), size(Depth2));
